...
tokenResponseParsed = Just (ApiResponse {apiType = "regular", response = CreateTokenResponse {token = 123456789, unassociatedCert = "false"}, errorCode = 0, errorMsg = "", warnings = [], timestamp = 1403115433})
...
updateDefinedIPsRequestData = UpdateDefinedIPsRequest
                              ...
                              , updateDefinedIPsToken = "1234567890"
                              }
